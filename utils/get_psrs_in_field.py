...
def extract_psrs_from_html(soup):
    ...
    if 'No pulsars' in soup:
        ...
        columns = ['PSR', 'RA (deg)', 'DEC (deg)', 'P (ms)',
                   'DM (pc cm^-3)', 'Survey', 'Separation (deg)']
...
if __name__ == "__main__":
    ...
    parser.add_option(
        '--tag', type=str, help='Unique tag for final csv file', dest="tag", default="MeerKAT")
    parser.add_option('--search_coordinates', type=str,
                      help='Reference coordinates', dest="coords", default="12:08 -59:36")
    parser.add_option('--search_radius', type=str, help='Radius in deg. around coordinates to look for psrs',
                      dest="radius", default="1.2")  # IB at L-Band
    parser.add_option('--search_dm', type=str,
                      help='Reference DM to search in pc cm^-3', dest='dm', default="")
    parser.add_option('--search_dm_tolerance', type=str,
                      help='search DM tolerance in pc cm^-3', dest="dm_tol", default="10.0")
    parser.add_option('--output_path', type=str, help='Output path to the csv file',
